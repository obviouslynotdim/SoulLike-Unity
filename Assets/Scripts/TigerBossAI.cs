...
public class TigerBossAI : MonoBehaviour
{
    ...
    [SerializeField] private GameObject bossHealthUIPanel; // Assign the UI Panel here
    ...
    private void SetupComponents()
    {
        ...
        if (bossHealthUIPanel != null) bossHealthUIPanel.SetActive(false);
    }
    ...
    private void Update()
    {
        ...
        // --- UI LOADING LOGIC ---
        // Activate UI the first time the player is sighted
        if (hasPlayerInSight && !uiActivated)
        {
            uiActivated = true;
            if (bossHealthUIPanel != null) bossHealthUIPanel.SetActive(true);
        }
